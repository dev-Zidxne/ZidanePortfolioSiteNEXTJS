  ...
  return (
    <div className="relative flex cursor-pointer group">
      <motion.img
        ...
        src=""
        className="object-cover w-24 h-24 transition duration-300 ease-in-out border border-red-500 rounded-full md:h-28 xl:w-32 xl:h-32 group-hover:opacity-80 group-hover:bg-red-600 md:w-28 "
      />
