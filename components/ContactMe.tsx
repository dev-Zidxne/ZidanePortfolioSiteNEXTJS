...
function ContactMe({ pageInfo }: Props) {
  ...
  return (
    <div className="relative flex flex-col items-center h-screen max-w-2xl m-auto overflow-x-auto overflow-y-auto text-center md:text-left md:flex-row justify-evenly">
      {!isTabletOrMobile && (
      ...
      <div className="flex flex-col ">
        ...
        <form
          onSubmit={sendEmail}
          className="flex flex-col w-screen p-5 space-y-2 md:w-fit sm:w-fit md:h-fit sm:h-fit "
        >
          {!isTabletOrMobile && (
