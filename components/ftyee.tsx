...
<section>
  ...
  <div class="mx-auto w-full max-w-5xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
    ...
    <div class="flex flex-col items-stretch">
      <!-- Title -->
      <h2 class="mb-5 text-center text-3xl font-bold md:text-5xl">Short heading goes here</h2>
      <p class="mb-20 text-center text-sm sm:text-base">Lorem ipsum dolor sit amet, consectetur adipiscing</p>
      <!-- Content -->
      <div class="gap-x-8 [column-count:1] md:grid-cols-2 md:gap-x-4 md:[column-count:2]">
        ...
        <div class="mb-12 inline-block border border-solid border-[#cdcdcd] md:mb-8 lg:mb-10">
          <img src="https://assets.website-files.com/624380709031623bfe4aee60/6243807090316262904aee69_Placeholder%20Image%20-%20Landscape.svg" alt="" class="inline-block" />
          <div class="px-5 py-8 sm:px-6">
            <h5 class="mb-3 text-xl font-bold">Project name here</h5>
            <p class="flex-col text-[#808080]">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna</p>
        ...
        <!-- Item -->
        <div class="mb-12 inline-block border border-solid border-[#cdcdcd] md:mb-8 lg:mb-10">
          <img src="https://assets.website-files.com/624380709031623bfe4aee60/6243807090316203124aee66_placeholder-image.svg" alt="" class="inline-block" />
          <div class="px-5 py-8 sm:px-6">
            <h5 class="mb-3 text-xl font-bold">Project name here</h5>
            <p class="flex-col text-[#808080]">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus magna fringilla urna</p>
            <div class="mb-5 mt-6 flex flex-wrap gap-2 md:mb-6 lg:mb-8">
