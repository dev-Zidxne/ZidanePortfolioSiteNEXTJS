...
export default function Projects({ projects }: Props) {
  return (
    <motion.div
      ...
      className="relative flex flex-col items-center h-screen p-0 mx-auto  md:text-left md:flex-row max-w-screen justify-evenly  space-y-7 xl:h-[700px] top-10"
    >
      <h3 className="absolute uppercase top-6  ml-6 tracking-[20px] text-gray-500 text-2xl  lg:text-4xl ">
        Projects
      </h3>
      <h3 className="absolute top-16 tracking-[2px] text-gray-500 text-sm lg:text-xl lg:top-28  md:top-52 ">
      ...
      <div className="relative z-30 flex w-full transition  scrollbar-thin overflow-y-hidden snap-x snap-mandatory hover:scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 bottom-20 ">
        {projects.map((project, i) => (
          <div
            ...
            className="flex flex-col items-center justify-center flex-shrink-0 w-screen h-screen space-y-5 overflow-y-scroll p- snap-center md:p-44 "
          >
              ...
              <Link href={project.linkToBuild}>
                <a target="_blank">
                  <motion.img
                   ...
                   lg:mt-40 cursor-pointer  rounded-md md:mt-40 "
                  />
                </a>
              </Link>
            </div>
